      ...
      <div className="w-full max-w-8xl relative">
        ...
        <div className="relative sm:rounded-3xl overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-10 md:py-24 lg:py-32 min-h-[400px] sm:min-h-[600px] lg:min-h-[700px]">
            ...
            <div className="absolute flex bottom-0 left-1/2 transform -translate-x-1/2 z-20">
              <svg
                className="absolute bottom-0 left-[-20px] transform -translate-x-1/2 z-20"
                height="17"
                width="43"
                fill="none"
                viewBox="0 0 43 17"
              ...
              <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2.5 sm:py-3 bg-white rounded-tr-xl rounded-tl-xl shadow-xl">
                <span className="text-gray-900 font-medium text-sm sm:text-base md:text-base whitespace-nowrap">
              ...
              <svg
                className="absolute bottom-0 left-[370px] transform -translate-x-1/2 z-20"
                height="17"
                width="43"
                fill="none"
                viewBox="0 0 43 17"
